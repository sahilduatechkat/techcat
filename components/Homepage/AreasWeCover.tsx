...
export const AreasWeCover = () => {
  return (
    <div className='xl:h-[1397px] bg-[#0A0615] w-full mt-[-300px] sm:mt-[-160px] md:mt-[-120px] lg:mt-[-350px] relative overflow-hidden pt-[350px] sm:pt-[220px] md:pt-[200px] lg:pt-[420px] pb-[40px] lg:pb-[100px] xl:pb-0'>
        <Image 
            src={CircleBg}
            alt='circle-bg'
        ...
        <div className='mt-7 lg:mt-14 text-white px-6 lg:px-[100px] z-10 relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
